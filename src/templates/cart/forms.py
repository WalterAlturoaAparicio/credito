...
from .models import ColourVariation, OrderItem, Product, SizeVariation, Address, User
...
class AddToCartForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['colour'].queryset = product.avaible_colours.all()
        self.fields['size'].queryset = product.avaible_sizes.all()
